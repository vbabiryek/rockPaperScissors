...
class RpsGame():
    def __init__(self):
        ...
        self.r_btn = pygame.image.load("img/rockButton.png").convert_alpha()
        self.p_btn = pygame.image.load("img/paperButton.png").convert_alpha()
        self.s_btn = pygame.image.load("img/scissorsButton.png").convert_alpha()
        ...
        self.font = pygame.font.Font(('img/Splatch.ttf'), 70)
        self.text = self.font.render(f" ", True, (250, 250, 250))
    ...
    def player(self):
        if self.rock_btn.clicked(30):
            self.p_option = "rock"
            self.screen.blit(self.choose_rock, (120, 180))
        elif self.paper_btn.clicked(340):
            self.p_option = "paper"
            self.screen.blit(self.choose_paper, (120, 180))
        else:
            self.scissors_btn.clicked(640)
            self.p_option = "scissors"
            self.screen.blit(self.choose_scissors, (120, 180))
    ...
    def computer(self):
        ...
        pc_option = self.screen.blit(pc_choice, (400, 180))
        return pc_option
